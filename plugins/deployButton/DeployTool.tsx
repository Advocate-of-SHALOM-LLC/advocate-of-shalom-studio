...
// Namespaced per-project so multiple Studios on the same browser don't
// share/overwrite each other's "last deploy" indicators.
const LAST_DEPLOY_KEY = 'aos_last_deploy';
